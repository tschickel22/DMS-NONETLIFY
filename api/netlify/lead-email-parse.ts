// Auto-generated wrapper for netlify/functions/lead-email-parse.js
// Route: /api/netlify/lead-email-parse
type HandlerModule = { handler?: (event:any, context:any)=>Promise<any> } | any;
async function loadHandler(){
  const mod: HandlerModule = await import('../../netlify/functions/lead-email-parse.js');
  const h = (mod as any).handler ?? (mod as any).default?.handler ?? (mod as any).default;
  if (typeof h !== 'function') { throw new Error('No Netlify handler export in ../../netlify/functions/lead-email-parse.js'); }
  return h;
}
