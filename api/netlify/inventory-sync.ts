// Auto-generated wrapper for netlify/functions/inventory-sync.js
// Route: /api/netlify/inventory-sync
type HandlerModule = { handler?: (event:any, context:any)=>Promise<any> } | any;
async function loadHandler(){
  const mod: HandlerModule = await import('../../netlify/functions/inventory-sync.js');
  const h = (mod as any).handler ?? (mod as any).default?.handler ?? (mod as any).default;
  if (typeof h !== 'function') { throw new Error('No Netlify handler export in ../../netlify/functions/inventory-sync.js'); }
  return h;
}
