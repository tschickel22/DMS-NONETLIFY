// Auto-generated wrapper for netlify/functions/share-resolve.js
// Route: /api/netlify/share-resolve
type HandlerModule = { handler?: (event:any, context:any)=>Promise<any> } | any;
async function loadHandler(){
  const mod: HandlerModule = await import('../../netlify/functions/share-resolve.js');
  const h = (mod as any).handler ?? (mod as any).default?.handler ?? (mod as any).default;
  if (typeof h !== 'function') { throw new Error('No Netlify handler export in ../../netlify/functions/share-resolve.js'); }
  return h;
}
