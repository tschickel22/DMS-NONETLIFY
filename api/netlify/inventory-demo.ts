// Auto-generated wrapper for netlify/functions/inventory-demo.ts
// Route: /api/netlify/inventory-demo
type HandlerModule = { handler?: (event:any, context:any)=>Promise<any> } | any;
async function loadHandler(){
  const mod: HandlerModule = await import('../../netlify/functions/inventory-demo.ts');
  const h = (mod as any).handler ?? (mod as any).default?.handler ?? (mod as any).default;
  if (typeof h !== 'function') { throw new Error('No Netlify handler export in ../../netlify/functions/inventory-demo.ts'); }
  return h;
}
