// Auto-generated wrapper for netlify/functions/syndication-feed.js
// Route: /api/netlify/syndication-feed
type HandlerModule = { handler?: (event:any, context:any)=>Promise<any> } | any;
async function loadHandler(){
  const mod: HandlerModule = await import('../../netlify/functions/syndication-feed.js');
  const h = (mod as any).handler ?? (mod as any).default?.handler ?? (mod as any).default;
  if (typeof h !== 'function') { throw new Error('No Netlify handler export in ../../netlify/functions/syndication-feed.js'); }
  return h;
}
