// Auto-generated wrapper for netlify/functions/share-link-crud.js
// Route: /api/netlify/share-link-crud
type HandlerModule = { handler?: (event:any, context:any)=>Promise<any> } | any;
async function loadHandler(){
  const mod: HandlerModule = await import('../../netlify/functions/share-link-crud.js');
  const h = (mod as any).handler ?? (mod as any).default?.handler ?? (mod as any).default;
  if (typeof h !== 'function') { throw new Error('No Netlify handler export in ../../netlify/functions/share-link-crud.js'); }
  return h;
}
