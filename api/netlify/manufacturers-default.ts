// Auto-generated wrapper for netlify/functions/manufacturers-default.ts
// Route: /api/netlify/manufacturers-default
type HandlerModule = { handler?: (event:any, context:any)=>Promise<any> } | any;
async function loadHandler(){
  const mod: HandlerModule = await import('../../netlify/functions/manufacturers-default.ts');
  const h = (mod as any).handler ?? (mod as any).default?.handler ?? (mod as any).default;
  if (typeof h !== 'function') { throw new Error('No Netlify handler export in ../../netlify/functions/manufacturers-default.ts'); }
  return h;
}
